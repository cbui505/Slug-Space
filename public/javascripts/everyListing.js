var everyListing = (function(){
        function initEveryListing() {
      ...
      function observeUserLoginState(){
        ...
        return {
            get everyListing() {return everyListing;},
            set everyListing(v) {everyListing = v},
            initEveryListing: initEveryListing
        }
    }());